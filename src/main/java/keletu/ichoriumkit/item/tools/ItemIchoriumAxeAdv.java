...
public class ItemIchoriumAxeAdv extends ItemAxe implements IHasModel, IAdvancedTool {

    public ItemIchoriumAxeAdv(String name, CreativeTabs tab, ToolMaterial material) {

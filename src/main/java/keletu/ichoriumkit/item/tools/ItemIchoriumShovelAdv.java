...
public class ItemIchoriumShovelAdv extends ItemSpade implements IHasModel, IAdvancedTool {
    public ItemIchoriumShovelAdv(String name, CreativeTabs tab, ToolMaterial material) {
